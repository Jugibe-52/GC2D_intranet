...
method classes.  The four implicit methods expose two nonlinear selectors and
...
physical with tracking, and fully extended with tracking.  Each implicit class
therefore admits $2\times2\times3=12$ canonical configurations.
\texttt{ABBA2Midpoint} has no nonlinear residual and supports the same three
strategies.  The five public classes consequently represent
$4\times12+3=51$ canonical configurations.
