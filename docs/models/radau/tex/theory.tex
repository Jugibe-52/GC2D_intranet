...
\]
The collocation equations are implicit and are solved by SciPy Newton iterations. The public adapter accepts an optional physical-state Jacobian callable; otherwise SciPy uses finite differences. Its dimension is unchanged by energy tracking.
...
One retained SciPy implicit adaptive solver. Energy tracking is optional and passive.
