# HBVM42: state formulations and execution

Four Gauss quadrature stages and a rank-two Legendre solve.
...
HBVM42 uses the **physical** rows. `track_energy=False` is the default;
