...
\path{src/methods/extended/order2_midpoint.py}. It uses the common
\texttt{midpoint\_step}, the uncoupled ABBA pair in \texttt{composition.py},
and the same passive energy quadrature as implicit ABBA and BM4.
