...
The class exposes the same controls as the other implicit ABBA methods: two
projection formulations, Newton or Broyden, physical or fully extended state,
and optional physical energy tracking.  Fully extended execution always
enables energy evolution.  The selected values are global to the outer step.
