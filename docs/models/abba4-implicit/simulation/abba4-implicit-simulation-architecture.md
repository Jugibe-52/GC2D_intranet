# ABBA4Implicit: state formulations and execution

Three signed unprojected ABBA maps enclosed by one spatial Hairer projection.
...
ABBA4Implicit uses the **duplicated** rows. `track_energy=False` is the default;
