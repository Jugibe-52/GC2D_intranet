# ABBA6Implicit: state formulations and execution

Seven signed projected ABBA maps.
...
ABBA6Implicit uses the **duplicated** rows. `track_energy=False` is the default;
