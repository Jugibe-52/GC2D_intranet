...
its end. The coefficients remain unchanged. ABBA4, ABBA6 and BM4 each
use one outer projection around their complete unprojected compositions.
ABBA6 therefore differs from historical results with seven projected pairs. This internal family name does not enable the retired full
