# BM4Midpoint: state formulations and execution

Twelve direct/adjoint stages followed by one spatial arithmetic mean.
...
BM4Midpoint uses the **duplicated** rows. `track_energy=False` is the default;
