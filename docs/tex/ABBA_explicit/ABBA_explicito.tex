...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\color{gris}GC2D: método ABBA explícito}
\fancyhead[R]{\small\color{gris}Cálculo de la jacobiana}
\fancyfoot[C]{\thepage}
...
\begin{center}
  {\LARGE\bfseries\color{azul}Jacobiana del método ABBA con proyección mediante la media}\par
  \vspace{0.35em}
  {\large Cálculo explícito para el problema GC2D}\par
  \vspace{0.4em}
  {\small Método explícito sin multiplicadores ni iteraciones de Newton}
\end{center}
