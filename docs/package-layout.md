...
| `initial_conditions` | Initial-state providers, concrete layouts, and geometry | `GCInitialConfiguration`, `GCStateLayout`, `FCInitialConfiguration`, `FCStateLayout`, `Area` |
