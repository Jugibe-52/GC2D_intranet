...
with tempfile.TemporaryDirectory() as directory:
    ...
    assert restored.sync()==[40]*16 and len(client.calls)==128
...
atomic_json(ROOT/'aws/validation_cloud_store.json',{
    'verified_utc':utc_now(),'committed_pairs':64,'upload_data_before_marker':True,
...
print('64 checkpoint pairs: ordering, restored hashes, deduplication and corruption checks passed.')
