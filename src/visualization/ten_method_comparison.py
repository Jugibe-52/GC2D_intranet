...
TEN_METHOD_COLORS: Mapping[str, str] = {
	...
	"Implicit ABBA 1 (Newton)": "tab:blue",
	"Implicit ABBA 1 (Broyden)": "cornflowerblue",
	"Implicit ABBA 2 (Newton)": "tab:orange",
	"Implicit ABBA 2 (Broyden)": "goldenrod",
...
TEN_METHOD_SHORT_LABELS: Mapping[str, str] = {
	"Midpoint ABBA": "ABBA\nmidpoint",
	"Midpoint BM4": "BM4\nmidpoint",
	"Implicit ABBA 1 (Newton)": "ABBA 1\nNewton",
	"Implicit ABBA 1 (Broyden)": "ABBA 1\nBroyden",
	"Implicit ABBA 2 (Newton)": "ABBA 2\nNewton",
	"Implicit ABBA 2 (Broyden)": "ABBA 2\nBroyden",
