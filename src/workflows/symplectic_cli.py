"""Compatibility CLI for Fourier potential simulations."""
...
def parse_args() -> argparse.Namespace:
	parser = argparse.ArgumentParser(
		description="Run the compatibility symplectic workflow from configuration."
	)
	...
	parser.add_argument(
		...
		help="Configuration version under conf/<surface>/fourier/<group>/.",
	)
	parser.add_argument(
		"--version",
		default="symplectic_grid",
		help="Profile inside the configuration file.",
	)
	return parser.parse_args()


def _run_legacy_case(params: FourierParams) -> None:
	run_method(make_system(params))
